...
global.mess = {
    ...
    botAdmin: '`මට ඇඩ්මින් දීපම් බන්☹️`',
    owner: '`උබ මගෙ අයිතිකාරයා නේමේනෙ හුත්තො🤣`',
...
global.owner = [process.env.OWNER_NUMBER] || ['94719404435'] // Owner number , (අයිතිකරුගේ නම්බර් එක )

module.exports = {    
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD:FramesAlive',
...
OWNER_NUMBER: process.env.OWNER_NUMBER || '94719404435'  ,    
